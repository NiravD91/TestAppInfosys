...
class CustomTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        imageHrefView.leadingAnchor.constraint(equalTo: self.contentView.leadingAnchor,
        ...
        containerView.leadingAnchor.constraint(equalTo: self.imageHrefView.trailingAnchor,
                                               constant: 10).isActive = true
